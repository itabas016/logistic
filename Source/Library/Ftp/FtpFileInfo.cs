...
namespace PayMedia.Integration.IFComponents.BBCL.Logistics
{
    ...
    public class FtpFileInfo : IFtpFileInfo
    {
        ...
        public string Extension
        {
            ...
            set
            {
                System.IO.Path.ChangeExtension(this.Filename, value);
            }
        }
        ...
        /// <param name="useRegEx">true = <paramref name="line"/> contains a Regular Expression<br/>faluse = <paramref name="line"/> contains a literal filename</param>
        /// <remarks></remarks>
        public FtpFileInfo(string line, string path, bool useRegEx)
        {
            if (!useRegEx)
            {
                _filename = line;
